...
public:
    ...
    static SendDirRequest makeSendDirRequest(const Glib::ustring& file, int32_t parent=0) noexcept;
    static SendFileRequest makeSendFileRequest(const Glib::ustring& file, int32_t parent=0) noexcept;
...
private:
    ...
    void m_sendFile(const Glib::RefPtr<Gio::Socket>& sock, const Glib::ustring path, int32_t parent=0) noexcept;
    void m_sendDir(const Glib::RefPtr<Gio::Socket>& sock, const Glib::ustring path, int32_t parent=0) noexcept;
};
