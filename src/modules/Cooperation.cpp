...
Cooperation::Cooperation() noexcept:
    m_service(new DBus::Service{"com.deepin.system.Cooperation", Gio::DBus::BusType::BUS_TYPE_SYSTEM}),
        ...
        m_methodPair(new DBus::Method("Pair", DBus::Method::warp(this, &Cooperation::pair), {{"ip", "s"}, {"port", "i"}})),
        m_methodSendFile(new DBus::Method("SendFile", DBus::Method::warp(this, &Cooperation::sendFile), {{"filepath", "s"}})),
        m_propertyDevices(new DBus::Property("Devices", "as", DBus::Property::warp(this, &Cooperation::getDevices))),
        m_propertyPairedDevice(new DBus::Property("PairedDevice", "s", DBus::Property::warp(this, &Cooperation::getPairedDevice))),
        m_socketScan(Gio::Socket::create(Gio::SocketFamily::SOCKET_FAMILY_IPV4, Gio::SocketType::SOCKET_TYPE_DATAGRAM, Gio::SocketProtocol::SOCKET_PROTOCOL_UDP)),
        m_socketListenScan(Gio::Socket::create(Gio::SocketFamily::SOCKET_FAMILY_IPV4, Gio::SocketType::SOCKET_TYPE_DATAGRAM, Gio::SocketProtocol::SOCKET_PROTOCOL_UDP)),
        m_socketListenPair(Gio::Socket::create(Gio::SocketFamily::SOCKET_FAMILY_IPV4, Gio::SocketType::SOCKET_TYPE_STREAM, Gio::SocketProtocol::SOCKET_PROTOCOL_TCP)),
        m_socketConnect(Gio::Socket::create(Gio::SocketFamily::SOCKET_FAMILY_IPV4, Gio::SocketType::SOCKET_TYPE_STREAM, Gio::SocketProtocol::SOCKET_PROTOCOL_TCP)),
        m_socketConnected(Gio::Socket::create(Gio::SocketFamily::SOCKET_FAMILY_IPV4, Gio::SocketType::SOCKET_TYPE_STREAM, Gio::SocketProtocol::SOCKET_PROTOCOL_TCP))
{
    ...
    try
    {
        ...
        Gio::signal_socket().connect(
            [this](Glib::IOCondition cond){
                return m_scanRequestHandler(cond);
            }, 
            m_socketListenScan, 
            Glib::IO_IN
        );
        ...
        Gio::signal_socket().connect(
            [this](Glib::IOCondition cond){
                return m_scanResponseHandler(cond);
            }, 
            m_socketScan, 
            Glib::IO_IN
        );
        ...
        Gio::signal_socket().connect(
            [this](Glib::IOCondition cond){
                return m_pairRequestHandler(cond);
            }, 
            m_socketListenPair, 
            Glib::IO_IN
        );
                       ...
                       const Glib::RefPtr<Gio::DBus::MethodInvocation>& invocation) noexcept
{
    ...
    Gio::signal_socket().connect(
        [this](Glib::IOCondition cond){
            return m_mainHandler(cond, m_socketConnect);
        }, 
        m_socketConnect, 
        Glib::IO_IN
    );
...
bool Cooperation::m_scanRequestHandler(Glib::IOCondition cond) const noexcept
{
    ...
    auto local = Glib::RefPtr<Gio::InetSocketAddress>::cast_dynamic<Gio::SocketAddress>(m_socketListenPair->get_local_address());
...
bool Cooperation::m_pairRequestHandler(Glib::IOCondition cond) noexcept
{
    ...
    auto remote = Glib::RefPtr<Gio::InetSocketAddress>::cast_dynamic<Gio::SocketAddress>(m_socketConnected->get_remote_address());
    ...
    INFO("connected by %s@%s:%d\n", request.master_name().c_str(), remote->get_address()->to_string().c_str(), remote->get_port());
    Gio::signal_socket().connect(
        [this](Glib::IOCondition cond){
            return m_mainHandler(cond, m_socketConnected);
        }, 
        m_socketConnected, 
        Glib::IO_IN
    );
...
bool Cooperation::m_mainHandler(Glib::IOCondition cond, const Glib::RefPtr<Gio::Socket>& sock) noexcept
{
    ...
    case TransferRequestType:
        {
            auto response = m_fileReciever.parseRequest(Message::recv_message_body<TransferRequest>(sock, base));
