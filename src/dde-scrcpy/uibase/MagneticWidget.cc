...
void MagneticWidget::moveEvent(QMoveEvent *event) {
    ...
    if (m_adsorbPos & AP_INSIDE_LEFT && parentRect.intersects(targetRect) &&
    ...
    if (m_adsorbPos & AP_INSIDE_RIGHT && parentRect.intersects(targetRect) &&
    ...
    if (m_adsorbPos & AP_INSIDE_TOP && parentRect.intersects(targetRect) &&
    ...
    if (m_adsorbPos & AP_INSIDE_BOTTOM && parentRect.intersects(targetRect) &&
