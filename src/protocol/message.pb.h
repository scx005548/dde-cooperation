...
class ApplyTransFilesRequest;
class ApplyTransFilesRequestDefaultTypeInternal;
extern ApplyTransFilesRequestDefaultTypeInternal _ApplyTransFilesRequest_default_instance_;
class ApplyTransFilesResponse;
class ApplyTransFilesResponseDefaultTypeInternal;
extern ApplyTransFilesResponseDefaultTypeInternal _ApplyTransFilesResponse_default_instance_;
class FileAction;
...
template<> ::ApplyTransFilesRequest* Arena::CreateMaybeMessage<::ApplyTransFilesRequest>(Arena*);
template<> ::ApplyTransFilesResponse* Arena::CreateMaybeMessage<::ApplyTransFilesResponse>(Arena*);
...
class ApplyTransFilesRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ApplyTransFilesRequest) */ {
 public:
  ApplyTransFilesRequest();
  virtual ~ApplyTransFilesRequest();

  ApplyTransFilesRequest(const ApplyTransFilesRequest& from);

  inline ApplyTransFilesRequest& operator=(const ApplyTransFilesRequest& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  ApplyTransFilesRequest(ApplyTransFilesRequest&& from) noexcept
    : ApplyTransFilesRequest() {
    *this = ::std::move(from);
  }

  inline ApplyTransFilesRequest& operator=(ApplyTransFilesRequest&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ApplyTransFilesRequest& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const ApplyTransFilesRequest* internal_default_instance() {
    return reinterpret_cast<const ApplyTransFilesRequest*>(
               &_ApplyTransFilesRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    21;

  void Swap(ApplyTransFilesRequest* other);
  friend void swap(ApplyTransFilesRequest& a, ApplyTransFilesRequest& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline ApplyTransFilesRequest* New() const final {
    return CreateMaybeMessage<ApplyTransFilesRequest>(nullptr);
  }

  ApplyTransFilesRequest* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ApplyTransFilesRequest>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const ApplyTransFilesRequest& from);
  void MergeFrom(const ApplyTransFilesRequest& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ApplyTransFilesRequest* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return nullptr;
  }
...
class ApplyTransFilesResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ApplyTransFilesResponse) */ {
 public:
  ApplyTransFilesResponse();
  virtual ~ApplyTransFilesResponse();

  ApplyTransFilesResponse(const ApplyTransFilesResponse& from);

  inline ApplyTransFilesResponse& operator=(const ApplyTransFilesResponse& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  ApplyTransFilesResponse(ApplyTransFilesResponse&& from) noexcept
    : ApplyTransFilesResponse() {
    *this = ::std::move(from);
  }

  inline ApplyTransFilesResponse& operator=(ApplyTransFilesResponse&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ApplyTransFilesResponse& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const ApplyTransFilesResponse* internal_default_instance() {
    return reinterpret_cast<const ApplyTransFilesResponse*>(
               &_ApplyTransFilesResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    22;

  void Swap(ApplyTransFilesResponse* other);
  friend void swap(ApplyTransFilesResponse& a, ApplyTransFilesResponse& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline ApplyTransFilesResponse* New() const final {
    return CreateMaybeMessage<ApplyTransFilesResponse>(nullptr);
  }

  ApplyTransFilesResponse* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ApplyTransFilesResponse>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const ApplyTransFilesResponse& from);
  void MergeFrom(const ApplyTransFilesResponse& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ApplyTransFilesResponse* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return nullptr;
  }
  ...
  // @@protoc_insertion_point(class_scope:ApplyTransFilesResponse)
 private:
  class HasBitSetters;
...
class RemoteService_Stub : public RemoteService {
 public:
  ...
  void filetrans_update(::google::protobuf::RpcController* controller,
                       ...
                       ::FileTransResponse* response,
                       ::google::protobuf::Closure* done);
  void apply_trans_files(::google::protobuf::RpcController* controller,
                       const ::ApplyTransFilesRequest* request,
                       ::ApplyTransFilesResponse* response,
                       ::google::protobuf::Closure* done);
 private:
...
// string appName = 2;
inline void ApplyTransFilesRequest::clear_appname() {
  appname_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& ApplyTransFilesRequest::appname() const {
  // @@protoc_insertion_point(field_get:ApplyTransFilesRequest.appName)
  return appname_.GetNoArena();
}
inline void ApplyTransFilesRequest::set_appname(const ::std::string& value) {
  
  appname_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:ApplyTransFilesRequest.appName)
}
#if LANG_CXX11
inline void ApplyTransFilesRequest::set_appname(::std::string&& value) {
  
  appname_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:ApplyTransFilesRequest.appName)
}
#endif
inline void ApplyTransFilesRequest::set_appname(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  appname_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:ApplyTransFilesRequest.appName)
}
inline void ApplyTransFilesRequest::set_appname(const char* value, size_t size) {
  
  appname_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:ApplyTransFilesRequest.appName)
}
inline ::std::string* ApplyTransFilesRequest::mutable_appname() {
  
  // @@protoc_insertion_point(field_mutable:ApplyTransFilesRequest.appName)
  return appname_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ApplyTransFilesRequest::release_appname() {
  // @@protoc_insertion_point(field_release:ApplyTransFilesRequest.appName)
  
  return appname_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void ApplyTransFilesRequest::set_allocated_appname(::std::string* appname) {
  if (appname != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:ApplyTransFilesRequest.appName)
}
...
// bool result = 1;
inline void ApplyTransFilesResponse::clear_result() {
  result_ = false;
}
inline bool ApplyTransFilesResponse::result() const {
  // @@protoc_insertion_point(field_get:ApplyTransFilesResponse.result)
  return result_;
}
inline void ApplyTransFilesResponse::set_result(bool value) {
  
  result_ = value;
  // @@protoc_insertion_point(field_set:ApplyTransFilesResponse.result)
}
