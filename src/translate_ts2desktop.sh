...
DDE_COOPERATION_TEMP_FILE=apps/dde-cooperation/setup/linux/dde-cooperation.desktop.tmp
...
DEEPIN_DATA_TRANSFER_TEMP_FILE=apps/data-transfer/setup/linux/deepin-data-transfer.desktop.tmp
