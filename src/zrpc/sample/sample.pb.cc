...
static const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* file_level_service_descriptors_sample_2eproto[1];
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_sample_2eproto = {
  false, false, 415, descriptor_table_protodef_sample_2eproto, "sample.proto", 
